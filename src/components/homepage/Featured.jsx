...
const Featured = async () => {
  ...
  return (
    <section className="bg-card py-24 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6 mb-14">
          ...
          <div>
            ...
            <h2
              className="text-primary font-black leading-tight tracking-tighter"
              style={{ fontSize: "clamp(2rem, 4.5vw, 3.25rem)" }}
            >
              Featured{" "}
              <span className="text-[#007A55] dark:text-[#00E5A0]">Facilities</span>
            </h2>
